// This file contains all the constant strings used in the app, such as titles,
// button labels, and error messages. By centralizing these strings in one place,
// we can easily manage and update them without having to search through the
